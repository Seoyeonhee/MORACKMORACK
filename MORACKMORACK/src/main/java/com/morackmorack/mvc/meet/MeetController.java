...
public class MeetController {
	...
	public ModelAndView addMeet(@ModelAttribute("meet") Meet meet, HttpServletRequest request) throws Exception{
		...
		meet.setMeetLoc("¼­¿ï½Ã"); //³ªÁß¿¡ Áö¿ö¶û
		...
		meet.setLeaderId(userId);
	     ...
	     if(bank.equals("±â¾÷") || bank.equals("±¹¹Î")) {
	    	 len = 14;
	     }else if(bank.equals("³óÇù") || bank.equals("¿ì¸®")) {
	    	 len = 13;
	     }else if(bank.equals("ÇÑ±¹¾¾Æ¼") || bank .equals("½ÅÇÑ")) {
	    	 len = 12;
	     }else if(bank.equals("SCÁ¦ÀÏ")) {
	    	 len = 11;
	     }
