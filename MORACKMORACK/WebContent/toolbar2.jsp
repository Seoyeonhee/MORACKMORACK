...
<div id="menubar">
	<ul id="menubar-menus">
		<li>
			<a href="#">모임 검색</a>
			<div>
			<p><a href="/meet/listMeet?listType=type">모임 유형 검색</a></p>
			<p><a href="/meet/listMeet?listType=hashtag">해시태그 검색</a></p>
			<p><a href="/meet/listMeet?listType=category">카테고리 검색</a></p>
			</div>		
		</li>
		<li>
			<a href="#">모임 관리</a>
		...
		<li>
			<a href="#">업체</a>
			<div>
			<p><a href="#">추천 업체 목록</a></p>
			<p><a href="#">업체 이용 목록 조회</a></p>
			</div>	
		</li>
		<li>
			<a href="#">후기 관리</a>
			<div>
			<p><a href="#">모임 후기 조회</a></p>
			<p><a href="#">업체 후기 조회</a></p>
			</div>		
		</li>
		<li>
			<a href="#">마이페이지</a>
			<div>
			<p><a href="#">내 정보 조회</a></p>
			<p><a href="#">내 정보 변경</a></p>
			<p><a href="#">회원 탈퇴</a></p>
			</div>	
		</li>
	</ul>
